...
public class Util {
  ...
  public static Translation3d flipRedBlue(Translation3d original) {
    return new Translation3d(
        FieldConstants.fieldLength - original.getX(), original.getY(), original.getZ());
  }

  public static Pose2d flipRedBlue(Pose2d original) {
    return new Pose2d(
        FieldConstants.fieldLength - original.getX(), original.getY(), original.getRotation());
  }

  public static Translation2d flipRedBlue(Translation2d original) {
    return new Translation2d(FieldConstants.fieldLength - original.getX(), original.getY());
  }
