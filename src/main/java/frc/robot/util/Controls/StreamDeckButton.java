...
public class StreamDeckButton {
    ...
    public StreamDeckButton withInactiveConfig(String inactive_background, String inactive_foreground, String inactive_text) {
    ...
    public List<String> getDataToPublish() {
        ...
        dataToPublish.add(inactive_foreground);
        dataToPublish.add(active_text);
        dataToPublish.add(inactive_text);
