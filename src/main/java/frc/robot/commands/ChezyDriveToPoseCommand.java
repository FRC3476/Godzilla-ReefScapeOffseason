...
public class ChezyDriveToPoseCommand extends Command {
  ...
  public ChezyDriveToPoseCommand(
      DriveSubsystem driveSubsystem,
      RobotState robotState,
      Supplier<Pose2d> targetLocation,
      double constraintFactor) {
    this.driveSubsystem = driveSubsystem;
    this.targetLocation = targetLocation.get();
    ...
    this.driveController =
        new ProfiledPIDController(
            ...
            new TrapezoidProfile.Constraints(
                ...
                Constants.DriveConstants.kMaxAccelerationMetersPerSecondSquared * constraintFactor),
            0.02);
    ...
    double thetaVelocity =
        thetaController.getSetpoint().velocity * ffScaler
            + thetaController.calculate(
                currentPose.getRotation().getRadians(), targetLocation.getRotation().getRadians());
    thetaErrorAbs =
