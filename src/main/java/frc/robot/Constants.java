...
public final class Constants {
  ...
  public static class SuperstructureConstants {
    ...
    public static double STOW_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-95.1526249);
    public static double STOW_INTAKE_ROTATION_RADIAN = Units.degreesToRadians(104.5837512);

    public static double STOW_CORAL_ELEVATOR_HEIGHT_INCH = 0.0;
    public static double STOW_CORAL_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-95.1526249);
    public static double STOW_CORAL_INTAKE_ROTATION_RADIAN = Units.degreesToRadians(104.5837512);

    public static double STOW_ALGAE_ELEVATOR_HEIGHT_INCH = 0.0;
    public static double STOW_ALGAE_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-38.3080987);
    public static double STOW_ALGAE_INTAKE_ROTATION_RADIAN = Units.degreesToRadians(104.5837512);

    public static double INTAKE_CORAL_ELEVATOR_HEIGHT_INCH = 0.0;
    public static double INTAKE_CORAL_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-95.1526249);
    ...
    public static double INTAKE_CORAL_L1_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-95.1526249);
    public static double INTAKE_CORAL_L1_INTAKE_ROTATION_RADIAN = Units.degreesToRadians(-26.9162484);

    public static double FEED_ELEVATOR_HEIGHT_INCH = 0.0;
    public static double FEED_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-95.1526249);
    ...
    public static double L1_PIVOT_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-95.1526249);
    ...
    //Away from reef 7.078988in
    public static double L2_AIM_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-16.3769186);
    //Away from reef 17.7998883in
    ...
    //Away from reef 23.003301in
    public static double L3_AIM_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-16.3769186);
    //Away from reef 17.7998883in
    ...
    public static double L4_AIM_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(3.1972053);//Away from reef (no against)
    ...
    public static double L1_SCORE_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-95.1526249);
    ...
    //Away from reef 7.078988in
    public static double L2_SCORE_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-16.3769186);
    //Away from reef 17.7998883in
    ...
    //Away from reef 23.003301in
    public static double L3_SCORE_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-16.3769186);
    //Away from reef 17.7998883in
    ...
    //Away from reef 53.4375
    public static double L4_SCORE_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(3.1972053);//Away from reef (no against)
    ...
    public static double ALGAE_HIGH_INTAKE_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-56.8542103);
    public static double ALGAE_HIGH_INTAKE_INTAKE_ROTATION_RADIAN = Units.degreesToRadians(-26.9162484);

    public static double ALGAE_LOW_INTAKE_ELEVATOR_HEIGHT_INCH = 30.907161;
    public static double ALGAE_LOW_INTAKE_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-56.8542103);
    public static double ALGAE_LOW_INTAKE_INTAKE_ROTATION_RADIAN = Units.degreesToRadians(-26.9162484);

    public static double PROCESSOR_AIM_ELEVATOR_HEIGHT_INCH = 0.0;
    public static double PROCESSOR_AIM_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(-38.3080987);
    public static double PROCESSOR_AIM_INTAKE_ROTATION_RADIAN = Units.degreesToRadians(-26.9162484);

    public static double BARGE_AIM_ELEVATOR_HEIGHT_INCH = 53.4375;
    public static double BARGE_AIM_FORWARD_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(43.8547133);
    public static double BARGE_AIM_BACKWARD_ENDEFFECTOR_ROTATION_RADIANS = Units.degreesToRadians(119.8473749);
    public static double BARGE_AIM_CENTER_ENDEFFECTOR_ROTATION_RADIANS = (BARGE_AIM_BACKWARD_ENDEFFECTOR_ROTATION_RADIANS + BARGE_AIM_FORWARD_ENDEFFECTOR_ROTATION_RADIANS)/2;
