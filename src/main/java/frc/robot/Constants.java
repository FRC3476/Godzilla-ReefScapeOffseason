...
public final class Constants {
  ...
  public static class DriveConstants {
    ...
    public static final double AUTO_ALIGN_BARGE_FORWARD_PERPENDICULAR_OFFSET = 1.4;
    public static final double AUTO_ALIGN_BARGE_BACKWARD_PERPENDICULAR_OFFSET = 1.4;
