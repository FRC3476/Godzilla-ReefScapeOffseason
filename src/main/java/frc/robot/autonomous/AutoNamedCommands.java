...
public class AutoNamedCommands {
    ...
    public AutoNamedCommands(Superstructure superstructure, Intake intake, Drive drive, Claw claw, Vision vision){
    ...
    public void registerNamedCommands(){
        ...
        NamedCommands.registerCommand("L4_aim", 
                superstructure.setStateCommand(SuperstructureState.L4_AIM, "Aim L4")
        );
        ...
        NamedCommands.registerCommand("L4_fadeaway", 
                Commands.sequence(
                    claw.rollerSTOP(),
        ...
        NamedCommands.registerCommand("drive_to_coral", 
                DriveCommands.driveToCoral(drive, vision, intake)
        );
