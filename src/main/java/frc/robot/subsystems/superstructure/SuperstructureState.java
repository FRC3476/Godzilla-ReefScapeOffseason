...
public enum SuperstructureState {
  ...
  private final Command superstructureCommand;
  ...
  SuperstructureState(double elevatorHeight, double endEffectorRotation, double intakeRotation) {
    ...
    this.superstructureCommand = new ParallelCommandGroup(
  ...
  public Command getSuperstructureCommand(){
