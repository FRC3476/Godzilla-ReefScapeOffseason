...
public class CompTunerConstants {
  ...
  private static final LinearVelocity driveMaxSpeedCalculatedMPS =
      driveMaxSpeedCalculatedRPS.asFrequency().times(2 * Math.PI).times(kWheelRadius);
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.1298828125);
