...
// public class ClawNew extends ServoMotorSubsystem<MotorInputsAutoLogged, MotorIO> {

//   private final RobotState robotState;

//   //   private static final LoggedTunableNumber rollerVolts =
//   //       new LoggedTunableNumber(
//   //           "Claw/RollerVolts", 1.0); // It was already set to 1.0 and used in rollerFWD and
//   // rollerRVS
...
//   //       new LoggedTunableNumber("Claw/RollerScoringVolts",
//   // EndEffectorConstants.ROLLER_SCORING_VOLTS);
...
//   public ClawNew(ServoMotorSubsystemConfig config, MotorIO io, RobotState robotState) {
...
//     return new Trigger(
//         () ->
//             isClawScoring() && isCoralInClaw() && !firstSensorTriggered &&
// !secondSensorTriggered);
//   }
...
//               break;
//             case HOLDING_CORAL:
//               // move coral forward if at first sensor, backward if at second sensor, do nothing
// if
//               // staged
//               if (coralPosition == CoralStateTracker.CoralPosition.AT_FIRST_END_EFFECTOR) {
