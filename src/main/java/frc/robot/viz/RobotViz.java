...
public class RobotViz {
  ...
  private LoggedMechanismLigament2d driveLigament =
      new LoggedMechanismLigament2d("drivetrain", 0.76, 0.0, 5.0, red);
  ...
  private LoggedMechanismLigament2d elevatorLigament =
      new LoggedMechanismLigament2d("elevator", 0.13, 90.0, 20.0, orange);
  ...
  public RobotViz(RobotContainer container, RobotState robotState) {
  ...
  private void init2dViz() {
    ...
    elevatorLigament = new LoggedMechanismLigament2d("elevator", 0.13, 90.0, 20.0, orange);
  ...
  public void updateViz() {
    ...
    double elevatorHeightM = elevator.getCurrentPosition();
